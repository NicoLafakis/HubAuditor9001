      ...
      metrics: [
        {
          ...
          severity: 'good',
          description: 'The total number of contacts in your HubSpot database.',
        },
      ],
    },
    {
      ...
      metrics: [
        {
          ...
          description: 'Contacts with the same email address. Duplicates can confuse your sales team and skew your reports. You should merge these to keep your database clean.',
        },
        {
          label: 'Missing Email',
          ...
          description: 'Contacts without an email address. These contacts can\'t be reached via email campaigns, which limits your marketing efforts.',
        },
        {
          label: 'Missing Phone',
          ...
          description: 'Contacts without a phone number. If your team does phone outreach, these contacts will be harder to reach.',
        },
        {
          ...
          description: 'The percentage of emails that permanently failed to deliver (invalid addresses). High bounce rates can hurt your email deliverability and sender reputation.',
        },
      ],
    },
    {
      ...
      metrics: [
        {
          ...
          description: 'Contacts that aren\'t assigned to any sales rep or owner. These leads might be falling through the cracks without anyone following up.',
        },
        {
          ...
          description: 'Contacts that haven\'t been updated in over 3 months. These might be outdated or inactive contacts that need attention or cleanup.',
        },
      ],
    },
    {
